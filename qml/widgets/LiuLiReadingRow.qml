...
//  property string name: item && item.title_cn || ""
  property string day: item && item.day || ""
  property string title_cn: item && item.title_cn || ""
  property string title_en: item && item.title_en || ""
  property string handle: item && item.handle || ""
  property string tag: item && item.tag || ""
  property string time: item && item.time || ""
  property string text: item && item.day || ""
  property string image: item && item.share_img || ""
  property string share_img: item && item.share_img || ""
  property string source: item && item.source || ""
...
//      visible: cell.share_img.length > 0 && !img.error

//      source: cell.share_img
